...
export const COUNTRIES = {
  ...
  MX: { name: 'Mexico',        flag: '🇲🇽', currency: 'MXN', dial: '+52', lang: 'es',  emergency: { all: '911' }, plugs: ['A','B'], voltage: 127, freq: 60, water: 'unsafe', drive: 'right' },
  ...
  FR: { name: 'France',        flag: '🇫🇷', currency: 'EUR', dial: '+33', lang: 'fr',  emergency: { all: '112' }, plugs: ['C','E'], voltage: 230, freq: 50, water: 'safe', drive: 'right' },
  ES: { name: 'Spain',         flag: '🇪🇸', currency: 'EUR', dial: '+34', lang: 'es',  emergency: { all: '112' }, plugs: ['C','F'], voltage: 230, freq: 50, water: 'safe', drive: 'right' },
  PT: { name: 'Portugal',      flag: '🇵🇹', currency: 'EUR', dial: '+351', lang: 'pt', emergency: { all: '112' }, plugs: ['C','F'], voltage: 230, freq: 50, water: 'safe', drive: 'right' },
  DE: { name: 'Germany',       flag: '🇩🇪', currency: 'EUR', dial: '+49', lang: 'de',  emergency: { all: '112', police: '110' }, plugs: ['C','F'], voltage: 230, freq: 50, water: 'safe', drive: 'right' },
  IT: { name: 'Italy',         flag: '🇮🇹', currency: 'EUR', dial: '+39', lang: 'it',  emergency: { all: '112' }, plugs: ['C','F','L'], voltage: 230, freq: 50, water: 'safe', drive: 'right' },
  NL: { name: 'Netherlands',   flag: '🇳🇱', currency: 'EUR', dial: '+31',  emergency: { all: '112' }, plugs: ['C','F'], voltage: 230, freq: 50, water: 'safe', drive: 'right' },
  CH: { name: 'Switzerland',   flag: '🇨🇭', currency: 'CHF', dial: '+41', lang: 'de',  emergency: { all: '112', police: '117', ambulance: '144' }, plugs: ['C','J'], voltage: 230, freq: 50, water: 'safe', drive: 'right' },
  AT: { name: 'Austria',       flag: '🇦🇹', currency: 'EUR', dial: '+43', lang: 'de',  emergency: { all: '112' }, plugs: ['C','F'], voltage: 230, freq: 50, water: 'safe', drive: 'right' },
  BE: { name: 'Belgium',       flag: '🇧🇪', currency: 'EUR', dial: '+32', lang: 'fr',  emergency: { all: '112' }, plugs: ['C','E'], voltage: 230, freq: 50, water: 'safe', drive: 'right' },
  ...
  JP: { name: 'Japan',         flag: '🇯🇵', currency: 'JPY', dial: '+81', lang: 'ja',  emergency: { police: '110', ambulance: '119', fire: '119' }, plugs: ['A','B'], voltage: 100, freq: 50, water: 'safe', drive: 'left' },
  ...
  CN: { name: 'China',         flag: '🇨🇳', currency: 'CNY', dial: '+86', lang: 'zh',  emergency: { police: '110', ambulance: '120', fire: '119' }, plugs: ['A','C','I'], voltage: 220, freq: 50, water: 'unsafe', drive: 'right' },
  HK: { name: 'Hong Kong',     flag: '🇭🇰', currency: 'HKD', dial: '+852', lang: 'zh', emergency: { all: '999', alt: '112' }, plugs: ['G'], voltage: 220, freq: 50, water: 'safe', drive: 'left' },
  TW: { name: 'Taiwan',        flag: '🇹🇼', currency: 'TWD', dial: '+886', lang: 'zh', emergency: { police: '110', ambulance: '119', fire: '119' }, plugs: ['A','B'], voltage: 110, freq: 60, water: 'caution', drive: 'right' },
  TH: { name: 'Thailand',      flag: '🇹🇭', currency: 'THB', dial: '+66', lang: 'th',  emergency: { police: '191', ambulance: '1669', tourist: '1155' }, plugs: ['A','B','C','O'], voltage: 230, freq: 50, water: 'unsafe', drive: 'left' },
  ...
  MA: { name: 'Morocco',       flag: '🇲🇦', currency: 'MAD', dial: '+212', lang: 'fr', emergency: { police: '19', ambulance: '15' }, plugs: ['C','E'], voltage: 220, freq: 50, water: 'unsafe', drive: 'right' },
  ...
  BR: { name: 'Brazil',        flag: '🇧🇷', currency: 'BRL', dial: '+55', lang: 'pt',  emergency: { police: '190', ambulance: '192', fire: '193' }, plugs: ['C','N'], voltage: 127, freq: 60, water: 'unsafe', drive: 'right' },
  AR: { name: 'Argentina',     flag: '🇦🇷', currency: 'ARS', dial: '+54', lang: 'es',  emergency: { all: '911', police: '101', ambulance: '107' }, plugs: ['C','I'], voltage: 220, freq: 50, water: 'caution', drive: 'right' },
  PE: { name: 'Peru',          flag: '🇵🇪', currency: 'PEN', dial: '+51', lang: 'es',  emergency: { all: '105', ambulance: '116' }, plugs: ['A','B','C'], voltage: 220, freq: 60, water: 'unsafe', drive: 'right' },
};
